...
import xLogo from "assets/images/X_logo_2023.svg.png";
import telegramLogo from "assets/images/telegram-icon-2048x1725-i4kw83ca.png";

const Header = () => {
  // TODO: Icons in header as svg
  // TODO: Update text
  return (
      ...
      <Container>
        <ul>
          <li>
            <a
              target="_blank"
              href="https://twitter.com/stieronsol?s=21&t=xUzLjYws287AsG4M_3YTsg"
          ...
          <li>
            <a
              target="_blank"
              href="https://dexscreener.com/solana/637i3PsgLd7unHibu2kZbJqUGwE4iq2wxuc2XcPYSzgp"
              className="header__logo-btn"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <p className="header__ca-text">
              CA: Cf56qhx1G25ZVy9q85HAgAqe4ikto9X67eZXjiq6Ayjh
            </p>
          </li>
        </ul>
      </Container>
